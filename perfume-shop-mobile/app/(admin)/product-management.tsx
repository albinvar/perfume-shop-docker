...
const ProductManagement = () => {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      if (storesList.length === 0 && user?.role === 'ADMIN') {
  ...
  }, [enhancedFetch, stores, user?.role]);
        ...
        >
          ...
          <View style={styles.productInfo}>
            ...
            {product.store ? (
              ...
              >
                {typeof product.store === 'object' ? product.store.name : `Store ${product.store}`}
              </Chip>
            ) : (
              <Chip 
                mode="outlined" 
  ...
  }, [openEditModal, calculateProfit, handleDeleteClick]);
